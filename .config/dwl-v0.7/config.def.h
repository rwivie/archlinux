...
static const float bordercolor[]           = COLOR(0x859289ff);
static const float focuscolor[]            = COLOR(0x7fbbb3ff);
...
static const char *const autostart[] = {
        "wbg", "/home/ron/Walls/everforest_gloom.png", NULL,
	/*"sh", "-c", "/home/ron/.local/bin/dwlstart.sh", NULL,*/
        NULL /* terminate */
};
...
static const Rule rules[] = {
	...
	{ "foot",                              "calcurse",              0,            0,              1,             -1,         0,             930,  40,   700,      500   },
	{ "nl.hjdskes.gcolor3",                NULL,                    0,            0,              1,             -1,         0,             0,    0,    0,        0     },
	{ "gcolor3",                           NULL,                    0,            0,              1,             -1,         0,             0,    0,    0,        0     },
	{ NULL,                                "scratchpad",            0,            0,              1,             -1,         's',           780,  370,  1000,     700   },
};
...
static const char *woficmd[] = { "wofi", "--show=drun", "--config=/home/ron/.config/wofi_dwl/config", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT,                    XKB_KEY_r,                      regions,                         SHCMD("grim -g \"$(slurp)\"") },
	{ MODKEY,                                       XKB_KEY_w,                      spawn,                           SHCMD("toggle_waybar_dwl.sh") },
	...
	{ 0,                                            XKB_KEY_XF86Tools,              spawn,                           SHCMD("st -g 120x30+30+55 -c ncmpcpp -e ncmpcpp") },
